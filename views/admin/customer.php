        ...
        <table class="table table-striped table-dark">
          <thead>
            ...
            <tr>
              ...
              <td><button class="btn btn-danger"><a onclick="return confirm('Are you sure you want to delete?');" style="color:white" href="../../controller/delete/deleteCustomer.php?email=<?php echo $email ?>">Delete</a></button></td>
            </tr>
